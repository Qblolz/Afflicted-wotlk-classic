...
function GTB:RegisterGroup(name, texture)
	...
	local obj = {name = name, frame = CreateFrame("Frame", nil, UIParent, BackdropTemplateMixin and "BackdropTemplate"), fontSize = 12, height = 16, obj = obj, bars = {}, usedBars = {}}
...
function GTB.RegisterBar(group, id, text, seconds, startSeconds, icon, r, g, b)
	...
	-- Update icon
	if( Afflicted.db.profile.showIcons ) then
