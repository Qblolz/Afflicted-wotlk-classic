					...
					showIcons = {
						...
						desc = L["Any announcement into a local channel, will show the icon of the spell that was announced."],
                                        ...
                                        hostileOnly = {
                                                order = 2,
                                                type = "toggle",
                                                name = "Show hostile spells only",
                                                desc = "Show only hostile spells. Disable to show also friendly spells.",
                                        },
				},
			},
			inside = {
                        ...
                        announcements = {
                                ...
                                args = {
                                        ...
                                        url = {
                                                ...
                                                name = L["URL"],
                                                set = false,
                                                get = function() return "http://www.curse.com/addons/wow/locknotes2" end,
                                                width = "full",
                                        },
                                },
                        },
